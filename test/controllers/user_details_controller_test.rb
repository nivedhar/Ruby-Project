...
class UserDetailsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create user_detail" do
    assert_difference('UserDetail.count') do
      post user_details_url, params: { user_detail: { dob: @user_detail.dob, email: @user_detail.email, mobile: @user_detail.mobile, name: @user_detail.name, title: @user_detail.title, user_id: @user_detail.user_id } }
    end
  ...
  test "should update user_detail" do
    patch user_detail_url(@user_detail), params: { user_detail: { dob: @user_detail.dob, email: @user_detail.email, mobile: @user_detail.mobile, name: @user_detail.name, title: @user_detail.title, user_id: @user_detail.user_id } }
